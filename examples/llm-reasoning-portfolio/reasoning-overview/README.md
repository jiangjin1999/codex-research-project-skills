...
- `_CHALLENGE_REGISTER.md` — portfolio-level drift and operational debt with owner, next action, safety boundary, and sync level.
...
- Challenges are recorded before repairs; do not turn every drift finding into a broad cleanup task.
